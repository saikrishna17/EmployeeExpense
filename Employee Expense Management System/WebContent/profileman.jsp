...
<ul>
<li class='drop'><a href='profileman.jsp'>Home</a></li>
...
<% 
num=0;
Statement st2=con.createStatement(ResultSet. TYPE_FORWARD_ONLY, ResultSet.CONCUR_UPDATABLE);
con.setAutoCommit(false);
...
out.println("("+num+")");
Statement st3=con.createStatement(ResultSet. TYPE_FORWARD_ONLY, ResultSet.CONCUR_UPDATABLE); 
